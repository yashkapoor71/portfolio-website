...
const ProjectsSection = () => {
    ...
    const otherProjects = [
        {
            title: "Weathery",
            description: "Weathery is a sleek, modern weather application designed to provide accurate and up-to-date weather information for any city in the world.",
            technologies: ["HTML", "CSS", "JavaScript", "OpenWeather API"],
            github: "https://github.com/yashkapoor71/weather-app",
            live: "https://weather-app-yashkapoor71.netlify.app/",
        },
    ];
